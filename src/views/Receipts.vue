<template>
  <div style="padding: 2rem; text-align: center;">
    <h1 style="font-size: 1.5rem; color: var(--text-primary); font-weight: 800;">Receipts</h1>
    <p style="color: var(--text-secondary); margin-top: 1rem;">This vault archive is currently being migrated to Vue SPA...</p>
