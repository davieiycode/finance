(function() {
  function applyAesthetics(theme, color, radius) {
    ...
    const themeMap = {
      dark: { bg: '#0f0f0f', card: '#1a1a1a', input: '#1f1f23', glass: 'rgba(255,255,255,0.03)', text: '#ffffff', border: '#27272a', sub: '#a1a1aa' },
      night: { bg: '#000000', card: '#0a0a0a', input: '#121212', glass: 'rgba(255,255,255,0.03)', text: '#ffffff', border: '#1a1a1a', sub: '#71717a' },
